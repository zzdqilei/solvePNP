...
int main(int argc, char** argv)
{
	...
	//初始化相机参数Opencv
	double camD[9] = { 
		437.708394972642, 0.0215647010762550, 326.049131157913,
		0, 437.514618572621, 243.694046766994,
		0, 0, 1 };
	...
	//DSC03321
	Points2D.push_back(cv::Point2f(298, 219));	//P1
	Points2D.push_back(cv::Point2f(309, 310));	//P2
	Points2D.push_back(cv::Point2f(131, 221));	//P3
	Points2D.push_back(cv::Point2f(83, 325));	//P4
	...
	Points3D.push_back(cv::Point3f(181, 0, 0));		//P2
	Points3D.push_back(cv::Point3f(0, 261, 0));		//P3
	Points3D.push_back(cv::Point3f(181, 261, 0));	//P4
	...
	fout << thetax << endl << thetay << endl << thetaz << endl;
	fout.close();
	/*************************************此处计算出相机的旋转角END**********************************************/
